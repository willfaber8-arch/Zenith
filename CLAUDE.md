...
lib/
  ...
  engines/
    ...
    SkillTreeFirewall.ts  Pure validation and transaction engine (Step 6.2) — no React imports.
                       ...
                       (a1_preview 150 shards → a2_particles 120 q_fuel → a3_typography 150 q_fuel+150 glass);
                       Branch B efficiency (b1_refinery 150 spores → b2_shield 120 q_fuel → b3_harvest
                       150 q_fuel+150 glass); Branch C cultivation (c1_aquarium 150 dust → c2_zoo 120 glass
                       → c3_projection 150 q_fuel+150 glass); Branch D synergy (d1_synthesis 150 shards →
                       d2_resonance 120 glass → d3_convergence 150 q_fuel+150 glass). Tier 2 costs less
                       in absolute terms than tier 1 because it is priced in refined resources, whose base
                       storage cap is 50 against 200 for raw — scarcer per unit, not cheaper. Never restate
                       these numbers anywhere else; read them from SKILL_TREE_MAP. SKILL_TREE_MAP:
