...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    body:  'That\'s the tour! Explore the sidebar to discover more — meal planning, library, trail finder, and the Arcade. You can replay this walkthrough any time from Settings → Help & Tour.',
